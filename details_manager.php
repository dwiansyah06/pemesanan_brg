  ...
  <div class="container">
      <div class="judul-content">
        ...
        <?php
          ...
          //ditolak manager
          $result2 = $mysqli->query("SELECT id_transaksi,product_code,product_name,units,date,keterangan FROM trash WHERE id_transaksi ='$nomor' and Action='N' ");
          ...
          //pending di admin
          $result4 = $mysqli->query("SELECT id_transaksi,product_code,product_name,units,date,keteranganmgr FROM approve WHERE id_transaksi ='$nomor' and Action='B' ");
            ...
            if($result){
              while($obj = $result->fetch_object()) {
                ...
                echo '<td class="text-center">'.$obj->units.'</td>';
                echo '<td>'.$obj->date.'</td>';
