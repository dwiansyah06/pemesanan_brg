  ...
  <div class="container">
    <div class="row" style="margin-top:3%;">
      <div class="judul-content">
          <center><h2 style="margin-bottom: 6%;">Update <span>Stock</span></h2></center>
      </div>
    ...
    <div class="col-xs-3 col-sm-2 col-md-2 pd-l-0">
      <div class="btn-group">
        <button type="button" class="btn btn-biru" id="btn-adm"><i class="fa fa-search"></i></button>
        <button class="btn btn-biru" id="btn-reset"><a href="admin.php"><span class="fa fa-times" style="color: #fff;"></a></span></button>
        ...
        <?php
          ...
          if ($result2) {
            while ($obj2 = $result2->fetch_object()) {
                ...
                echo '<li><a href="admin.php?kategori='.$obj2->kategori.'">'.$obj2->kategori.'</a></li>';
            }
          }
        ?>
        </ul>
      ...
      <div class="row" style="margin-top:70px;">
        <div class="col-md-12">
          <div class="view"><?php include "view_admin.php"; ?></div>
        </div>
    </div>
    </div>
  </div>
